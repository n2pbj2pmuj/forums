    ...
    <div className="min-h-screen bg-rojo-950 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md bg-black border border-rojo-900/50 rounded-3xl p-10 shadow-[0_0_50px_rgba(255,0,0,0.1)]">
        <div className="text-center mb-10">
          <h1 className="text-3xl font-black text-rojo-500 neon-red tracking-tighter mb-2 uppercase leading-none">Password Reset</h1>
          <p className="text-slate-500 text-xs font-bold uppercase tracking-widest mt-2">Restore account access</p>
        </div>
        ...
        {success ? (
          <div className="space-y-6 text-center py-4 animate-in fade-in zoom-in duration-500">
             ...
             <p className="text-slate-400 text-sm leading-relaxed">A recovery link has been sent to your email inbox. Use it to reset your password and regain account access.</p>
